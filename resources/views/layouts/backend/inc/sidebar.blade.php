				...
				@if (Request::is('user*'))
					...
					<li class="nav-item has-treeview">
						<a href="{{ route('user.pending.booking') }}" class="nav-link {{ Request::is('user/booking-request/list') ? 'active' : '' }}">
							<i class="fas fa-chalkboard"></i>
							<p class="ml-2">Pending Request</p>
						</a>
					</li>
